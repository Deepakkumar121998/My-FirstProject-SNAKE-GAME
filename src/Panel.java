...
//    width and hight set to the our desktop size
    ...
    int xsnake[] = new int[512];
    int ysnake[] = new int[512];
    ...
    public void gameover(Graphics graphic){
        ...
        graphic.setFont(new Font("Comic Sans", Font.BOLD, 40));
        fme = getFontMetrics(graphic.getFont());
        graphic.drawString("Press R to Restart", (width - fme.stringWidth("Press R to Replay"))/2, 3*height/4);
    }
